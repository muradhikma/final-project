...
<head>
    ...
    <title>Restaurant Reservaion System</title>
...
<body>
    ...
    <div class="all-content-wrapper mt-5">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                     ...
                                                     @if (Route::has('register'))
                                                        <li><a href="{{ route('register') }}"><span class="icon nalika-home author-log-ic"></span> Register</a>
                                                            @endif
                                                        </li>
